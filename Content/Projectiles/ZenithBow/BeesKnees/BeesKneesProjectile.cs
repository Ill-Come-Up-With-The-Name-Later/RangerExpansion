...
namespace UltimateRangerExpansion.Content.Projectiles.ZenithBow.BeesKnees
{
    class BeesKneesProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 30 == 0) // Shoot every 30 ticks
            {
                ...
                Projectile projectile = Main.projectile[Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity,
                    ProjectileID.BeeArrow, Projectile.damage, Projectile.knockBack,
