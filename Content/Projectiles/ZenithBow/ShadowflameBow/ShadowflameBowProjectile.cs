...
namespace UltimateRangerExpansion.Content.Projectiles.ZenithBow.ShadowflameBow
{
    class ShadowflameBowProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 6 == 0) // Shoot every 6 ticks
            {
                ...
                Projectile projectile = Main.projectile[Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity,
                    ProjectileID.ShadowFlameArrow, Projectile.damage, Projectile.knockBack,
